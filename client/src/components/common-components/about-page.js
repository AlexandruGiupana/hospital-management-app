...
const AboutPage = () => {
    ...
    return (
        <Container>
            <Row>
                <Col>
                    <h5 className="fs-2 mt-2" id = "aboutPageHeader">Informatii generale</h5>
            <p>Aplicatia Mediplus a fost lansata initial in anul 2015 cu scopul de a gestiona mai usor procesele interne din cadrul Spitalului Clinic de Urgenta pentru copii Louis Turcanu din Timisoara. Datorita activitatilor tot mai complexe desfasurate la nivel intern, aplicatia s-a dezvoltat continuu oferind tot mai multe functionalitati cu o complexitate tot mai ridicata. Functionalitatile oferite de aplicatie sunt destinate in principal personalului medical din interiorul institutiilor medicale, dar sunt oferite functionalitati care pot fi folosite direct de catre pacienti, fara sa fie nevoie de interventia neaparata a unui medic. <br/> <br/> In prezent aplicatia este folosita de mai multe spitale din Romania, majoritatea fiind spitale mari in care se desfasoara zilnic un numar mare de procese - operatii, consultatii, internari si externari din saloane, precum si altele. </p>
                </Col>
                <Col>
            <img
                src={hospital_image}
            ...
            <div className="container">
                ...
                <div className="counter-container">
                    ...
                    <div className="counter">
                        ...
                        <h3 data-target="500" className="count">0</h3>
                        <h6>Sleepless Nights</h6>
                    </div>
                </div>
            </div>

            <h5 className="text-black text-center display-5">Recomandat cu incredere de partenerii nostri:</h5>
            <br/>
            <Row>
