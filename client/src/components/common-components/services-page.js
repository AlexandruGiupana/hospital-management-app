...
const PricesPage = () => {
    ...
    return (
        <Container fluid>
            <h6 className="display-5" id="servicesPageHeader">Preturi servicii oferite</h6>
            <p className="fs-5" id="servicesPageP">Serviciile oferite, precum si pretul acestora se regasesc in tabelul de mai jos. Preturile sunt afisate in <b>lei</b> si includ TVA.
                <br/>
                Pentru mai multe detalii va rugam sa adresati intrebari prin trimiterea acestora la adresa <i>contact@mediplus.com</i>.
            </p>


            <TableContainer component={Paper} className="mb-lg-5" >
                <Table sx={{ minWidth: 300 }} aria-label="simple table" className="w-75 align-content-center" bordered responsive>
                    <TableHead>
                        <TableRow>
