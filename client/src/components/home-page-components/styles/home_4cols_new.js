      ...
      <Row className="justify-content-md-center">
        <Col>
          ...
          <DescriptionComponent>
            ...
            referitoare la situația consultărilor. Aplicația include și alte
      ...
      <Row className="justify-content-md-center">
        <Col>
          ...
          <DescriptionComponent>
            ...
            fi vizualizate și editate. Aplicația include opțiuni pentru exportul
      ...
      <Row className="justify-content-md-center">
        <Col>
          ...
          <DescriptionComponent>
            ...
            acces la datele tale personale, informații despre viitoarele
            programări, precum și despre consultațiile efectuate în trecut.
          </DescriptionComponent>
        </Col>
        <Col>
          <img
