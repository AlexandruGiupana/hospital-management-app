...
export const SELECT_APPOINTMENTS_DATA_OF_DOCTOR_QUERY =
  "SELECT appointments.id, appointments.start_date, appointments.end_date, health_services.service_name, patients.id, patients.first_name as patient_first_name, patients.last_name as patinet_last_name, doct.id, doct.first_name as doctor_first_name, doct.last_name as doctor_last_name" +
  " FROM appointments" +
